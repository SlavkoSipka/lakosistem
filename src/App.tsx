...
import { OProjektuPage } from './pages/OProjektuPage';
import { LoadingAnimation } from './components/LoadingAnimation';

type Page = 'home' | 'kontakt' | 'usluge' | 'o-projektu';
...
function App() {
  ...
  if (currentPage === 'o-projektu') {
    return <OProjektuPage onNavigate={handleNavigate} />;
  }
